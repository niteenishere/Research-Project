...
bagged_model=rfe_dt_results$fit
first_tree=bagged_model$mtrees[[1]]$btree
plot(first_tree, main = "Tree #1 from Bagged Ensemble")
text(first_tree,pretty=5)
...
visTree(first_tree, main = "Interactive Bagged Tree #1",width="100%")
...
# Extract the structure of Tree #1 as a data frame
# labelVar=TRUE ensures you see variable names, not just ID numbers
tree_1_structure <- getTree(rf_model, k = 1, labelVar = TRUE)

# View the first few splits
head(tree_1_structure)
